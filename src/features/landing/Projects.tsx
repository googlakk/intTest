            ...
            <div className="flex space-x-6">
              {['active', 'completed'].map((tab) => (
                <button
                  ...
                  className={`text-[11px] uppercase tracking-[0.2em] font-bold pb-2 border-b-2 transition-all ${activeTab === tab ? 'border-[#0A192F] text-[#0A192F]' : 'border-transparent text-gray-300 hover:text-gray-500'
                    }`}
                >
